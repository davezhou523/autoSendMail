...
func (m *defaultAttachModel) Insert(ctx context.Context, data *Attach) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.FileName, data.FilePath, data.Type, data.UserId, data.CompanyId)
	return ret, err
}
...
func (m *defaultAttachModel) Update(ctx context.Context, data *Attach) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.FileName, data.FilePath, data.Type, data.UserId, data.CompanyId, data.Id)
	return err
}
